...
namespace stan {
  ...
  namespace math {
      ...
      inline double F32(double a, double b, double c, double d, double e, double z, double precision = 1e-6)
      {
      ...
      inline void gradF32(double* g, double a, double b, double c, double d, double e, double z, double precision = 1e-6)
      {
      ...
      inline void grad2F1(double& gradA, double& gradC, double a, double b, double c, double z, double precision = 1e-6)
      {
      ...
      inline void gradIncBeta(double& g1, double& g2, double a, double b, double z)
      {
      ...
      inline void gradRegIncBeta(double& g1, double& g2, double a, double b, double z,
    ...
    inline double gradRegIncGamma(double a, double z, double g, double dig,
